import { ArrowDownAZ, Database, Filter, Settings2, WandSparkles } from "lucide-react";
      ...
      <Card>
        <CardHeader className="flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <CardDescription>Manage files and switch views from one compact header bar.</CardDescription>
          </div>
